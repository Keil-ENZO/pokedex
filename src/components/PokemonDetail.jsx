...
const PokemonDetail = (pokemonId = null) => {
    ...
    return (
        <main>
            <div className={"mt-12 flex flex-wrap justify-center"}>
                {listPokemon
                    .filter((pokemon) => {
                        return pokemonId.pokemonId ? pokemon.id === parseInt(pokemonId.pokemonId) : true;
                    })
                    .map((pokemon) => {
                        return (
                            <Card
                                className="w-[320px] h-[460px] flex items-center flex-col m-8 outline outline-[10px] outline-border bg-${color}"
                                key={pokemon.id}
                            >
